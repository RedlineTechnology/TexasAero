...
function ta_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'physical_address', array(
		'default'			=> __( '3038 N. Fry Rd. Suite #9, Katy, Texas 77449', 'ta' ),
	...
	$wp_customize->add_control( 'physical_address', array(
		...
		'type'			=> 'text',
		'label'			=> __( 'Physical Address', 'ta' ),
	));

	/* Add Phone Number */
	$wp_customize->add_setting( 'phone_number', array(
		'default'			=> __( '281.645.6132', 'ta' ),
		'sanitize_callback'	=> 'theme_slug_sanitize_html'
	));
	$wp_customize->add_control( 'phone_number', array(
		...
		'section'		=> 'title_tagline',
		'type'			=> 'text',
		'label'			=> __( 'Phone Number', 'ta' ),
	));

	/* SOCIAL MEDIA SECTION */
	$wp_customize->add_section( 'social_media', array(
		'title'       => __( 'Social Media', 'ta' ),
		'priority'    => 30,
	...
	$wp_customize->add_control( 'display_social_media', array(
		...
		'type'			=> 'checkbox',
		'label'			=> __( 'Display Social Media', 'ta' ),
	));
	...
	$wp_customize->add_control( 'google_analytics_id', array(
		...
		'description'	=> __( 'i.e., UA-XXXXXXXXX-1', 'ta' )
	));
	/* Google Analytics ID */
	$wp_customize->add_setting( 'google_tag_id', array(
		'default'			=> __( 'GTM-T76QC6J', 'ta' ),
		'sanitize_callback'	=> 'theme_slug_sanitize_html'
	));
	$wp_customize->add_control( 'google_tag_id', array(
		...
		'section'		=> 'tracking_scripts',
		'type'			=> 'text',
		'label'			=> __( 'Google Tag Manager ID', 'ta' ),
		'description'	=> __( 'i.e., GTM-XXXXXXX', 'ta' )
	));
	/* Head */
	...
	$wp_customize->add_control( 'footer_scripts', array(
		...
		'section'		=> 'tracking_scripts',
		'type'			=> 'textarea',
		'label'			=> __( 'Footer Scripts', 'ta' ),
	));

	/* FBO SECTION */
	$wp_customize->add_section( 'fbo', array(
		'title'       => __( 'FBO Settings', 'ta' ),
		'priority'    => 30,
		'capability'  => 'edit_theme_options'
	));
	/* Jet A Fuel Price */
	$wp_customize->add_setting( 'fuel_jeta', array(
		'default'			=> __( '$XXX.XX', 'ta' ),
		'sanitize_callback'	=> 'theme_slug_sanitize_html'
	));
	$wp_customize->add_control( 'fuel_jeta', array(
		'settings'		=> 'fuel_jeta',
		'section'		=> 'fbo',
		'type'			=> 'text',
		'label'			=> __( 'Jet A Fuel Price', 'ta' ),
	));
	/* Avgas Fuel Price */
	$wp_customize->add_setting( 'fuel_avgas', array(
		'default'			=> __( '$XXX.XX', 'ta' ),
		'sanitize_callback'	=> 'theme_slug_sanitize_html'
	));
	$wp_customize->add_control( 'fuel_avgas', array(
		'settings'		=> 'fuel_avgas',
		'section'		=> 'fbo',
		'type'			=> 'text',
		'label'			=> __( 'Avgas Fuel Price', 'ta' ),
	));
